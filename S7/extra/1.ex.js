...
console.log(rpgGames); // aqui tengo los rpg
const sumaScores = rpgGames.reduce(function (acc, rpgGame){
      return acc + rpgGame.score
},0)

const mediaScore = sumaScores/rpgGames.length;

console.log('La puntuacion media de los "Gammers" es: ', mediaScore);